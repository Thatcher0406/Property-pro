        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">520 Westpoint Apartments</h1>
              <span class="color-text-a">Langata, Nairobi</span>
            </div>
          </div>
            ...
            <div id="property-single-carousel" class="swiper">
              <div class="swiper-wrapper">
                <div class="carousel-item-b swiper-slide">
                  <img src="{{ asset('img/property-10.jpg') }}" alt="">
                </div>
                <div class="carousel-item-b swiper-slide">
                  <img src="{{ asset('img/property-8.jpg') }}" alt="">
                </div>
              </div>
            </div>
                ...
                <div class="property-price d-flex justify-content-center foo">
                  <div class="card-header-c d-flex">
                    <div class="card-box-ico">
                      <span class="bi bi-cash">Ksh.48,000</span>
                    </div>
              ...
              <div class="col-md-7 col-lg-7 section-md-t3">
                ...
                <div class="property-description">
                  <p class="description color-text-a">
                    The property is a 4-bedroom house located in the serene neighborhood of Langata. It has a spacious living room, a dining area, and a modern kitchen with a pantry. The master bedroom is en-suite while the other bedrooms share a common bathroom. The house also has a spacious garden and a parking area.
                  </p>
                  <p class="description color-text-a no-margin">
                    It also has a spacious garden and a parking area. The house is located in a secure neighborhood with easy access to social amenities such as schools, hospitals, and shopping centers.
                  </p>
                </div>
          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-6 col-lg-4">
                <img src="{{ asset('img/agent-5.jpg') }}" alt="" class="img-fluid">
              </div>
              <div class="col-md-6 col-lg-4">
                <div class="property-agent">
                  <h4 class="title-agent">Shirley Thatcher</h4>
                  <p class="color-text-a">
                    A landlord with PropertyPro, Shirley is a seasoned real estate agent with a wealth of experience in the industry.
                  </p>
                  <ul class="list-unstyled">
                    ...
                    <li class="d-flex justify-content-between">
                      <strong>Email:</strong>
                      <span class="color-text-a">wetindi.shirley@strathmore.edu</span>
                    </li>
                    <li class="d-flex justify-content-between">
                      <strong>Skype:</strong>
                      <span class="color-text-a">Shirley.ge</span>
                    </li>
                  </ul>
                  <div class="socials-a">
