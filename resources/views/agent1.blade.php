        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Gideon Kiprotich</h1>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="agent-avatar-box">
                  <img src=" {{ asset('img/agent-2.jpg') }}" alt="" class="agent-avatar img-fluid">
                </div>
              </div>
                ...
                <div class="agent-info-box">
                  ...
                  <div class="agent-content mb-3">
                    <p class="content-d color-text-a">
                      Gideon Kiprotich is a real estate agent with over 10 years of experience in the industry. He has helped hundreds of clients find their dream homes and is dedicated to providing the best service possible. Whether you're looking to buy, sell, or rent a property, Gideon can help you navigate the process with ease.
                    </p>
                    <div class="info-agents color-a">
                      ...
                      <p>
                        <strong>skype: </strong>
                        <span class="color-text-a"> Gideon.Es</span>
                      </p>
                      <p>
                        <strong>Email: </strong>
                ...
                <div class="card-overlay-a-content">
                  <div class="card-header-a">
                    <h2 class="card-title-a">
                      <a href="{{ url('property1') }}">820 Madaraka
                        <br> Amani Court</a>
                    </h2>
                  </div>
                  <div class="card-body-a">
                    ...
                    <a href="{{ url('property1') }}" class="link-a">Click here to view
