        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Contact <span class="color-b">Us</span></h1>
              <span class="color-text-a">PropertyPro has its headquarters at Madaraka Amani Court, Langata, Nairobi, Karuri Gakure Road.</span>
            </div>
          </div>
              ...
              <div class="col-md-5 section-md-t3">
                <div class="icon-box section-b2">
                  ...
                  <div class="icon-box-content table-cell">
                    ...
                    <div class="icon-box-content">
                      <p class="mb-1">Email.
                        <span class="color-a">propertypro@gmail.com</span>
                      </p>
                      <p class="mb-1">Phone.
                ...
                <div class="icon-box section-b2">
                  ...
                  <div class="icon-box-content table-cell">
                    ...
                    <div class="icon-box-content">
                      <p class="mb-1">
                        Madaraka Amani Court, Langata, Nairobi
                        <br> Karuri Gakure Road.
                      </p>
                    </div>
                  </div>
                </div>
