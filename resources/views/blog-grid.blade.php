        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Our Amazing <span class="color-b">Posts</span></h1>
              ...
              <div class="card-overlay">
                <div class="card-header-b">
                  <div class="card-category-b">
                    <a href="#" class="category-b">Properties</a>
                  </div>
            ...
            <div class="card-box-b card-shadow news-box">
              ...
              <div class="card-overlay">
                <div class="card-header-b">
                  ...
                  <div class="card-title-b">
                    <h2 class="title-2">
                      <a href="blog-single.html">New apartments
                        <br> added</a>
                    </h2>
                  </div>
                  <div class="card-date">
          ...
          <div class="col-md-4">
            <div class="card-box-b card-shadow news-box">
              ...
              <div class="card-overlay">
                <div class="card-header-b">
                  <div class="card-category-b">
                    <a href="#" class="category-b">Maintenance</a>
                  </div>
                  <div class="card-title-b">
                    <h2 class="title-2">
                      <a href="{{ url('blog1') }}">Maintenance is
                        <br> now available</a>
                    </h2>
                  </div>
                  <div class="card-date">
          ...
          <div class="col-md-4">
            <div class="card-box-b card-shadow news-box">
              ...
              <div class="card-overlay">
                <div class="card-header-b">
                  <div class="card-category-b">
                    <a href="{{ url('blog1') }}" class="category-b">Regions</a>
                  </div>
                  <div class="card-title-b">
                    <h2 class="title-2">
                      <a href="{{ url('blog1') }}">New regions
                        <br>added</a>
                    </h2>
                  </div>
                  <div class="card-date">
                    <span class="date-b">14 June 2024</span>
                  </div>
                </div>
              </div>
            </div>
