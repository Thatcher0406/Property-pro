    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="{{ url('/agents-grid') }}">Landlords</a>
          </li>
        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Shirley Thatcher</h1>
              <span class="color-text-a">Landlord</span>
            </div>
          </div>
          <div class="col-md-12 col-lg-4">
            <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                  <a href="{{ url('/agents-grid') }}">Landlords</a>
                </li>
      ...
      <div class="container">
        <div class="row">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="agent-avatar-box">
                  <img src=" {{ asset('img/agent-5.jpg') }}" alt="" class="agent-avatar img-fluid">
                </div>
              </div>
                ...
                <div class="agent-info-box">
                  ...
                  <div class="agent-content mb-3">
                    <p class="content-d color-text-a">
                        Shirley is a professional real estate agent with over 10 years of experience in the industry. She has a proven track record of helping clients find their dream properties. Whether you're looking to buy, sell, or rent a property, Shirley has the expertise to help you achieve your goals.
                    </p>
                    <div class="info-agents color-a">
                      <p>
                        <strong>Phone: </strong>
                        <span class="color-text-a"> +254 356 945234 </span>
                      </p>
                      <p>
                      ...
                      <p>
                        <strong>Email: </strong>
                        <span class="color-text-a"> shirley.thatcher@strathmore.edu</span>
                      </p>
                      <p>
                        <strong>skype: </strong>
                        <span class="color-text-a"> Shirley.Es</span>
                      </p>
                      <p>
                        <strong>Email: </strong>
          ...
          <div class="col-md-12 section-t8">
            <div class="title-box-d">
              <h3 class="title-d">My Properties (1)</h3>
            </div>
          </div>
                ...
                <div class="card-overlay-a-content">
                  <div class="card-header-a">
                    <h2 class="card-title-a">
                      <a href="{{ url('property2') }}">520 Westpoint
                        <br> Apartments</a>
                    </h2>
                  </div>
                  <div class="card-body-a">
                    <div class="price-box d-flex">
                      <span class="price-a">Rent | Ksh. 48,000</span>
                    </div>
                    <a href="{{ url('property2') }}" class="link-a">Click here to view
